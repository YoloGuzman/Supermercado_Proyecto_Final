...
public class updateProducto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet updateProducto</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>codigoProducto: " + request.getParameter("codigoP") + "</h1>");
            out.println("<h1>Incremento: " + request.getParameter("incremento") + "</h1>");
            out.println("<h1>Actual: " + request.getParameter("actual") + "</h1>");
            ...
            incremento+=actual;
            out.println("<h1>Nuevo: " + incremento + "</h1>");
            BDUser bd = new BDUser();
            bd.setDataBase();
            bd.connectingBD();
            bd.updateProducto(incremento, codigoProducto);
