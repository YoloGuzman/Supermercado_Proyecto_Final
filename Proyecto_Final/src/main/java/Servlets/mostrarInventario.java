 ...
 * @author reyg6
 */
@WebServlet(name = "MostrarInventario", urlPatterns = {"/inventa"})
public class mostrarInventario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<th><center><label>Inventario</label></center></th>");
            out.println("</tr>");
            ...
            out.println("<br/>");
            out.println("<img src='C:\\Users\\reyg6\\Documents\\NetBeansProjects\\SecondServlet\\Proyecto_Final\\src\\main\\java\\Servlets\\AguaSanta.jpg' alt='food'>");
            out.println("<br/>");
            out.println("<br/>");
