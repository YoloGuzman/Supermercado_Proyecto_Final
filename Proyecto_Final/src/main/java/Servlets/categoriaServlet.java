...
public class categoriaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Ingresar Categoria</h1>");
            out.println("<table border='1'>");
            out.println("<form action='guardarC' method='post'>");
            out.println("<tr>");
             out.println("<th>" + "<label>Codigo Categoria</label>" + "</th>");
             out.println("<th>" + "<label>Nombre Categoria</label>"+ "</th>");
             out.println("<th>" + "<label>Descripcion</label>" + "</th>");
                         
             out.println("</tr>");
             
             out.println("<tr>");
            
            out.println("<td>"+"<input type='number' name ='codigoCategoria'/>" + "</td>");
            out.println("<td>" + "<input type='text' name ='nombreCategoria'/>"  + "</td>");
            out.println("<td>" + "<input type='text' name ='Descripcion'/>"  + "</td>");
