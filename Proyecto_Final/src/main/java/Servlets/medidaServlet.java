 ...
 * @author reyg6
 */
@WebServlet(name = "igresoMedida", urlPatterns = {"/medida"})
public class medidaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<title>Ingreso Medidas</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Ingresar Medida</h1>");
             out.println("<table border='1'>");
            out.println("<form action='guardarMedida' method='post'>");
            out.println("<tr>");
            ...
            out.println("<td>"+"<input type='text' name ='medida'/>" + "</td>");
